...
/***/ (function(module, exports) {
	...
	{
		var _ajax = function _ajax(callback) {
			console.log('执行');
	...
	{
		// 多个回调执行!!
		var _ajax2 = function _ajax2(callback) {
			console.log('执行3');
			return new Promise(function (resolve, reject) {
				setTimeout(function () {
					resolve();
		...
		_ajax2().then(function () {
			...
			return console.log('第二次回调', "timeout3");
		});
	}
	...
	{
		//所有图片加载玩再加载页面
		var loadingImg = function loadingImg(src) {
			return new Promise(function (resolve, reject) {
		...
		Promise.all([loadingImg("http://i4.buimg.com/567571/dflef0720bea6832.png"), loadingImg("http://i4.buimg.com/567571/2b07ee25b08930ba.png"), loadingImg("http://i4.buimg.com/567571/5eb8190d6b2alc9c.png")]).then(showImgs);
	...
	{
		//所有图片加载玩再加载页面
		var _loadingImg = function _loadingImg(src) {
			return new Promise(function (resolve, reject) {
				var img = document.createElement('img');
				img.src = src;
				img.onload = function () {
		...
		Promise.race([_loadingImg("http://i4.buimg.com/567571/dflef0720bea6832.png"), _loadingImg("http://i4.buimg.com/567571/2b07ee25b08930ba.png"), _loadingImg("http://i4.buimg.com/567571/5eb8190d6b2alc9c.png")]).then(_showImgs);
